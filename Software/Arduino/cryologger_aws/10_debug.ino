...
void printTimers()
{
  ...
  DEBUG_PRINT("readSp212_1: ");     printTab(1);  DEBUG_PRINTLN(timer.readSp212_1);
  DEBUG_PRINT("readSp212_2: ");     printTab(1);  DEBUG_PRINTLN(timer.readSp212_2);
  DEBUG_PRINT("readteros10_1: ");  printTab(1);  DEBUG_PRINTLN(timer.readteros10_1);
  DEBUG_PRINT("readteros10_2: ");  printTab(1);  DEBUG_PRINTLN(timer.readteros10_2);
  //DEBUG_PRINT("readMb7354: ");      printTab(1);  DEBUG_PRINTLN(timer.readMb7354);
  DEBUG_PRINT("readMxBtx: ");       printTab(1);  DEBUG_PRINTLN(timer.readMxBtx);
